...
from meta_ads_performance import main as meta_ads_main
...
with DAG(
    dag_id="meta_ads_performance_raw_dag",
    default_args=default_args,
    description="Incrementally extract and load Meta Ads performance data into BigQuery",
    ...
    run_incremental_extraction = PythonOperator(
        task_id="extract_and_load_meta_ads_performance_raw_data",
