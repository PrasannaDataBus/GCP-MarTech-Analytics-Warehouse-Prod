...
def extract_user_location_data(customer_id: str, start_date: str, end_date: str, ads_client):
...
def main():
    ...
    for account in child_accounts:
        ...
        try:
            df = extract_user_location_data(customer_id, start_date, end_date, ads_client)
            if df.empty:
